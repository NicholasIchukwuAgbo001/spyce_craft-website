...
export default function App() {
    ...
    const TESTIMONIALS = [
        ...
        },
        {
            ...
            name: 'Emeka Nwosu',
            loc: 'Wuse, Abuja',
            review: 'I ordered three typographical satin black frames (â€œTAKE RISKSâ€, â€œKEEP GOINGâ€, â€œWORK HARDâ€) for my study desk. Standard of finish is immaculate. Packaged perfectly for shipping.',
            stars: 5,
        },
        {
            id: 't3',
    ...
    return (
        <div className="min-h-screen bg-brand-secondary flex flex-col text-[#ECE9E4] font-sans selection:bg-brand-primary/20 selection:text-brand-primary">
            ...
            {/* Main Dynamic View Content Swapper — padded to clear fixed header (~34px utility + ~80px nav) */}
            <div className="grow pt-[114px] isolate">
                {currentView === 'home' && (
                            ...
                            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                                ...
                                <div className="grid grid-cols-2 lg:grid-cols-3 gap-6">
                                    {[
                                        ...
                                        >
                                            <img src={cat.img} alt={cat.name} className="w-full h-full object-cover transition-transform duration-500" />
                                            ...
                                            <span className="absolute bottom-6 right-6 p-2 rounded-full bg-white/15 opacity-0 group-hover:opacity-100 transition-opacity text-white">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                                    {TESTIMONIALS.map((test, idx) => (
                                        ...
                                        >
                                            ...
                                            <p className="text-stone-600 text-xs sm:text-sm italic leading-relaxed font-sans">
                                                "{test.review}"
                                            </p>
                                            <div className="pt-4 border-t border-brand-secondary/20 flex justify-between items-center text-xs">
                                                <span className="font-bold text-stone-900 font-sans">{test.name}</span>
                            ...
                            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                                    {SOCIAL_FEED.map((post) => (
                                        ...
                                        >
                                            <img src={post.url} alt={post.title} className="w-full h-full object-cover transition-transform duration-500" />
                                            ...
                                            <span className="absolute top-4 left-4 bg-black/60 text-white text-[9px] font-bold px-2 py-0.5 rounded-full z-10 flex items-center gap-1">
                                ...
                                <div className="text-center pt-8 mt-4 space-x-4">
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noreferrer"
                                        className="inline-flex items-center gap-1.5 text-xs text-stone-800 hover:text-brand-primary font-bold font-sans uppercase tracking-wider"
                                    >
                                        ...
                                        return (
                                            ...
                                            >
                                                <button
                                                    ...
                                                    className="w-full text-left px-6 py-5 flex items-center justify-between font-serif text-base font-bold text-stone-900 select-none"
                                                >
                                                    <span>{faq.q}</span>
                                        ...
                                        <form id="contact-form-widget" onSubmit={handleContactSubmit} className="space-y-4">
                                            ...
                                            {contactSuccess && (
                                                <p id="contact-success-response" className="text-xs text-emerald-400 font-medium text-center animate-pulse">
                                                    WhatsApp is opening â€” just tap <strong>Send</strong> in the chat to submit. âœ¨
                                                </p>
                                            )}
                                        </form>
                                    </div>
