...
export default function AboutPage() {
 ...
 <h3 className="font-serif text-xl sm:text-2xl font-bold text-stone-900">Our Studio Mission</h3>
 ...
 <h3 className="font-serif text-xl sm:text-2xl font-bold text-stone-900">Our Design Vision</h3>
 <p className="text-stone-500 text-xs sm:text-sm leading-relaxed font-light">
 ...
 <h4 className="font-serif text-lg font-bold text-stone-900">{member.name}</h4>
