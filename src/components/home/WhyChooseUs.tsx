      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div id="usp-grid" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {USP_CARDS.map((card, idx) => (
            ...
            >
              <div className="w-12 h-12 rounded-xl bg-[#121216] border border-white/5 flex items-center justify-center shadow-md group-hover:scale-105 transition-transform">
                {card.icon}
              </div>
