    ...
    <section id="portfolio-gallery-section" className="py-20 bg-stone-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="relative overflow-hidden">
                  ...
                  <div className="absolute top-4 right-4 z-20 opacity-0 group-hover:opacity-100 transition-all duration-300 flex items-center gap-2">
                    <button
                      ...
                      className={`p-2.5 rounded-full backdrop-blur-md ${isLiked ? 'bg-red-500 text-white' : 'bg-white/80 hover:bg-white text-stone-800'} transition-all`}
                    >
                      <Heart className={`w-4 h-4 ${isLiked ? 'fill-white' : ''}`} />
                    </button>
                    <button
                      id={`gallery-view-${item.id}`}
                      className="p-2.5 rounded-full bg-white/80 hover:bg-white text-brand-dark backdrop-blur-md transition-all"
                    >
        ...
        {lightboxItem && (
          <div
            id="gallery-lightbox"
            className="fixed inset-0 z-50 bg-brand-dark/95 backdrop-blur-md flex items-center justify-center p-4 sm:p-6"
