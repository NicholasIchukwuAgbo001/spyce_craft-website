...
export default function Hero() {
    ...
    return (
        <section id="hero-section" className="relative z-0 bg-linear-to-b from-brand-secondary via-brand-muted to-brand-secondary py-16 lg:py-24 overflow-hidden border-b border-white/5">
