      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div id="hero-text-block" className="lg:col-span-6 space-y-8 text-center lg:text-left">
            ...
            <div className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-full bg-white/5 text-stone-200 text-[11px] font-semibold tracking-wider uppercase font-sans border border-white/10 hover:-translate-y-0.5 transition-transform backdrop-blur-md">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-2">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="w-full sm:w-auto px-8 py-4 rounded-xl bg-emerald-950/40 hover:bg-emerald-950/60 text-emerald-300 border border-emerald-500/30 font-semibold text-xs tracking-wide uppercase transition-all duration-300 transform active:scale-95 flex items-center justify-center gap-2 backdrop-blur-md"
              >
          ...
          <div id="hero-media-showcase" className="lg:col-span-6 relative">
            ...
            <div className="grid grid-cols-2 gap-4 relative">
              ...
              <div id="hero-floating-bubble" className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white/95 border border-brand-secondary/80 p-4 rounded-2xl shadow-2xl flex items-center gap-3 z-30 max-w-xs animate-bounce">
        ...
        <div id="brand-highlights-bar" className="grid grid-cols-2 md:grid-cols-4 gap-6 pt-16 mt-8 border-t border-brand-secondary">
          <div className="text-center md:text-left space-y-1">
            ...
            <p className="text-xs text-stone-500 font-sans">Never mass-produced; customized with care &amp; time</p>
          </div>
          <div className="text-center md:text-left space-y-1">
            <h3 className="font-serif text-lg font-bold text-brand-dark">Museum Grade Material</h3>
            <p className="text-xs text-stone-500 font-sans">Bubble-free resin coatings &amp; high-impact glass</p>
          </div>
          <div className="text-center md:text-left space-y-1">
            <h3 className="font-serif text-lg font-bold text-brand-dark">Bespoke Customization</h3>
            <p className="text-xs text-stone-500 font-sans">You sketch, draft quotes, select frame colors</p>
          </div>
          <div className="text-center md:text-left space-y-1">
            <h3 className="font-serif text-lg font-bold text-brand-dark">Safe Nationwide Delivery</h3>
            <p className="text-xs text-stone-500 font-sans">Double-packaged padding prevents cracks</p>
          </div>
        </div>
      </div>
    </section>
