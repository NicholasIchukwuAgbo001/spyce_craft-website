    ...
    return (
        <>
            <div className="fixed top-0 left-0 right-0 z-50 w-full">
                ...
                <div id="header-utility-bar" className="bg-[#121215] text-[11px] text-stone-300 font-sans tracking-wide border-b border-white/5 py-2 px-4 overflow-hidden">
                ...
                <header id="main-navigation-header" className="relative w-full bg-brand-secondary border-b border-white/5">
                    <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
                        <div className="flex items-center justify-between h-16 sm:h-20 gap-2">
                            ...
                            >
                                <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-brand-primary flex items-center justify-center text-brand-secondary shadow-lg transition-transform duration-300 shrink-0">
                            ...
                            <nav id="desktop-megamenu-nav" className="hidden lg:flex items-center gap-7">
                                ...
                                >
                                    ...
                                    {activeMegaMenu === 'shop' && (
                                        <div
                                            id="megamenu-shop"
                                            className="absolute left-1/2 translate-x-[-25%] top-8 w-[720px] bg-[#111114] border border-white/10 rounded-2xl shadow-2xl p-6 grid grid-cols-4 gap-6 animate-fadeIn text-left z-50"
                                        >
                                            {/* Column 1: Resin Art */}
                                ...
                                >
                                    ...
                                    {activeMegaMenu === 'collections' && (
                                        <div
                                            ...
                                            className="absolute left-1/2 translate-x-[-50%] top-8 w-[240px] bg-[#111114] border border-white/10 rounded-2xl shadow-2xl p-4 animate-fadeIn text-left z-50"
                                        >
                                ...
                                >
                                    ...
                                    {activeMegaMenu === 'gallery' && (
                                        <div
                                            id="megamenu-gallery"
                                            className="absolute left-1/2 translate-x-[-50%] top-8 w-[260px] bg-[#111114] border border-white/10 rounded-2xl shadow-2xl p-4 animate-fadeIn text-left z-50"
                                        >
                                ...
                                >
                                    ...
                                    {activeMegaMenu === 'blog' && (
                                        <div
                                            id="megamenu-blog"
                                            className="absolute left-1/2 translate-x-[-50%] top-8 w-[250px] bg-[#111114] border border-white/10 rounded-2xl shadow-2xl p-4 animate-fadeIn text-left z-50"
                                        >
                                            <ul className="space-y-1 text-xs text-stone-300">
                                                {[
                            ...
                            <div id="nav-utilities" className="flex items-center gap-1 sm:gap-3 shrink-0">
                                ...
                                >
                                    ...
                                    {cartCount > 0 && (
                                        <span className="absolute top-0 right-0 w-3.5 h-3.5 bg-brand-primary text-stone-950 text-[7px] font-bold flex items-center justify-center rounded-full ">
                                            {cartCount}
                                        </span>
                                    )}
                                </button>
                    ...
                    {mobileMenuOpen && (
                        <div
                            ...
                            className="lg:hidden absolute top-full left-0 w-full h-[calc(100vh-var(--header-h,98px))] bg-[#111114] border-t border-white/10 z-40 overflow-y-auto px-4 sm:px-6 py-4 animate-fadeIn pb-24"
                        >
