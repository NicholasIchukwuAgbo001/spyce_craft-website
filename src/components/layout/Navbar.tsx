...
export default function Navbar() {
 ...
 <header id="main-navigation-header" className="sticky top-[34px] z-40 w-full transition-all duration-300 bg-brand-secondary/90 border-b border-white/5">
 ...
 <div
 id="megamenu-shop"
 className="absolute left-1/2 translate-x-[-25%] top-8 w-[720px] bg-[#111114]/95 border border-white/10 rounded-2xl shadow-2xl p-6 grid grid-cols-4 gap-6 animate-fadeIn text-left "
 >
 {/* Column 1: Resin Art */}
