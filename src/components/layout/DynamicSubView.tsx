import React, { useState } from 'react'; import { useCartStore } from '../../store/useCartStore'; import { PRODUCTS } from '../../data/products'; import {
    ...
    return (
        <div id="dynamic-custom-subview" className="bg-brand-secondary min-h-screen text-stone-200 py-12 px-4 sm:px-6 lg:px-8">
            ...
            <section className="max-w-7xl mx-auto mb-16 rounded-3xl overflow-hidden border border-white/5 relative bg-[#111114]/80 backdrop-blur-md">
                <div className="grid grid-cols-1 lg:grid-cols-12">
                    ...
                    <div className="lg:col-span-5 aspect-16/10 lg:aspect-auto relative min-h-[300px]">
                        ...
                        <div className="absolute bottom-6 right-6 p-4 rounded-2xl bg-brand-secondary/80 backdrop-blur-md border border-white/5 text-right">
                                ...
                                >
                                    <div className="relative aspect-square overflow-hidden bg-stone-900">
                                        ...
                                        <button
                                            ...
                                            className="absolute top-4 right-4 p-2.5 bg-brand-secondary/60 backdrop-blur-md rounded-full text-white hover:text-red-500 transition-colors cursor-pointer"
                                        >
                                            <Heart className={`w-4 h-4 ${isItemWishlisted ? 'text-red-500 fill-red-500' : ''}`} />
                                        </button>
                                        {prod.customizable && (
                                            <div className="absolute bottom-4 left-4 right-4 text-center">
                                                <span className="inline-block bg-black/65 backdrop-blur-md text-brand-primary text-[9.5px] font-semibold uppercase tracking-wider py-1 px-3 rounded-full border border-brand-primary/20">
...
──────────────────────────────────────────────────────── */}
            {group === 'custom' && (
                <section className="max-w-4xl mx-auto bg-[#111114]/80 backdrop-blur-md rounded-3xl border border-white/5 p-6 sm:p-12 text-left space-y-10">
                        ...
                        {[
                            ...
                            >
                                <div className="aspect-16/10 overflow-hidden bg-stone-900 pointer-events-none">
                                    <img src={art.img} alt={art.title} className="w-full h-full object-cover group-hover:scale-103 transition-transform duration-500" />
                                </div>
