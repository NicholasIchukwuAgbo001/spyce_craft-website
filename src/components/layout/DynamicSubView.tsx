                ...
                <section className="max-w-7xl mx-auto space-y-12">
                    <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between border-b border-white/5 pb-4 gap-3">
                        <div className="space-y-1 text-left">
                            <h2 className="font-serif text-xl sm:text-3xl font-bold text-white">Curated Products</h2>
                            <p className="text-stone-400 text-xs font-sans">Handcrafted pieces in this collection.</p>
                        </div>
                    </div>
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="relative aspect-square overflow-hidden bg-stone-900">
                                            ...
                                            />
                                            {prod.salePrice ? (
                                                <span className="absolute top-3 left-3 bg-red-600 text-white text-[9px] font-bold uppercase px-2 py-0.5 rounded">
                                                    {Math.round(((prod.price - prod.salePrice) / prod.price) * 100)}% Off
                                                </span>
                                            ) : prod.tags.includes('best seller') ? (
                                                <span className="absolute top-3 left-3 bg-brand-primary text-stone-950 text-[9px] font-bold uppercase px-2 py-0.5 rounded">
                                                    Best Seller
                                                </span>
                                            ) : null}
                                            <button
                    ...
                    {/* CTA */}
                    <div className="p-6 sm:p-10 rounded-2xl border border-white/5 bg-[#111114] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
                        <div className="space-y-1">
                            <h3 className="font-serif text-lg sm:text-2xl font-bold text-white">Browse the full {normalizedTopic} range</h3>
                            <p className="text-stone-400 text-xs font-sans">See all available pieces with full filtering and sorting.</p>
                        </div>
                        <button
                            onClick={() => navigateTo('shop')}
                            className="shrink-0 px-6 py-3 rounded-xl bg-brand-primary text-stone-950 font-bold text-xs uppercase cursor-pointer"
                        >
                            Shop Collection
                        </button>
                    </div>
