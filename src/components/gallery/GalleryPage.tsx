                  ...
                  <div className="absolute inset-0 bg-linear-to-t from-brand-dark/95 via-brand-dark/20 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300 flex flex-col justify-end p-5">
                    ...
                    <div className="flex items-center justify-between mt-4 pt-3 border-t border-white/10">
                      <button
                        ...
                        className={`p-1.5 rounded-full bg-white/10 backdrop-blur-sm text-white hover:bg-white hover:text-red-500 transition-colors ${isLiked ? 'text-red-500 fill-red-500' : ''
                          }`}
                      >
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="p-1.5 rounded-full bg-white/10 backdrop-blur-sm text-white hover:bg-brand-primary transition-colors text-xs flex items-center gap-1 font-sans"
                        >
                          <Share2 className="w-3.5 h-3.5" />
                          <span>{copiedId === item.id ? 'Copied' : 'Share'}</span>
                        </button>
                        <span className="p-1.5 rounded-full bg-white/10 backdrop-blur-sm text-white text-[9px] font-mono leading-none">
