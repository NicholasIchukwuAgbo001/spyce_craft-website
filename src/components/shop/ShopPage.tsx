                    ...
                    >
                      ...
                      <div className="relative aspect-square overflow-hidden bg-stone-50">
                        ...
                        <button
                          ...
                          className="absolute top-2.5 right-2.5 w-7.5 h-7.5 rounded-full bg-white/90 backdrop-blur-sm shadow flex items-center justify-center text-stone-500 hover:text-red-500 z-10 transition-colors"
