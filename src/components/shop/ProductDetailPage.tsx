        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div id="product-detail-images" className="lg:col-span-6 space-y-4">
            <div className="aspect-square bg-stone-50 rounded-2xl overflow-hidden border border-stone-100 relative group">
              ...
              />
              <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-sm p-2 rounded-full cursor-pointer text-stone-600 hover:text-red-500 hover:scale-105 transition-transform">
                ...
                return (
                  ...
                  >
                    <div className="aspect-square rounded-lg overflow-hidden bg-stone-100">
                      <img src={p.images[0]} alt={p.name} className="w-full h-full object-cover group-hover:scale-102 transition-transform duration-300" referrerPolicy="no-referrer" />
                    </div>
                    <div className="space-y-1">
