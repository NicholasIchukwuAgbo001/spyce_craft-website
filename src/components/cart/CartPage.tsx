                                        ...
                                        >
                                            ...
                                            <div className="flex items-center justify-between sm:justify-end gap-6 w-full sm:w-auto pt-4 sm:pt-0 border-t sm:border-t-0 border-stone-100">
                                                ...
                                                <div className="text-right">
                                                    ...
                                                    <span className="font-mono text-sm font-bold text-stone-900">{formatNaira(currentPrice * item.quantity)}</span>
                                                </div>
                                    ...
                                    <div className="flex gap-2">
                                        <div className="relative grow">
                                            <input
                                                ...
                                                className="w-full px-4 py-2 pl-9 bg-white border border-stone-200 rounded-xl focus:outline-none focus:border-brand-primary placeholder:text-stone-400 text-xs font-sans"
                                            />
